...
let isConnected = reactive(false)
let accountAddr = reactive(null)
...
const login = async () => {
  if (window.ethereum) {
    ...
    accountAddr = accountList[0]
    isConnected = true

    console.log("🚀 ~ file: Navbar.vue ~ line 12 ~ login ~ accountAddr", accountAddr)
  } else {
    ...
    <nav
      ...
      <div class="container flex flex-wrap justify-between items-center mx-auto">
        ...
        <div class="flex md:order-2">
          ...
          <button v-if="!isConnected" type="button" @click="login"
            class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
            Login
          </button>

          <p v-if="isConnected">Connected: {{accountAddr.substring(0,6)}}...{{accountAddr.substring(38)}} </p>
